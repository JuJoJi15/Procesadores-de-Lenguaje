...
<COMPRA>{ 
    ...
    [0-9]+(\.[0-9]{1,2})?  {precio = unidades*descuento*Float.valueOf(yytext());yybegin(YYINITIAL);Ticket.addItemsDistintos(1);Ticket.addItems(unidades);Ticket.addCompra(precio);}
